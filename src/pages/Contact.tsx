...
const ContactForm: React.FC = () => {
  const [formData, setFormData] = useState<FormData>({
    ...
    subject: "",
    message: "",
    slotDateTime: "", // Initialize combined field
  });
  ...
  useEffect(() => {
    ...
    const now = new Date();
    const minDate = new Date(now.getTime() + 5 * 60000); // Minimum 5 minutes from now
    setMinDateTime(minDate.toISOString().slice(0, 16)); // Format for datetime-local
  }, []);
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const { name, email, phoneNumber, subject, message, slotDateTime } =
      formData;
  ...
  const resetForm = () => {
    setFormData({
      ...
      subject: "",
      message: "",
      slotDateTime: "", // Reset combined field
    });
  };
            ...
            <div className="contact-form">
              ...
              <div className="contact-form-bottom">
                ...
                >
                  ...
                  <div className="form-group">
                    <label htmlFor="slotDateTime">Slot Date & Time</label>
                    <input
                      type="datetime-local"
                      id="slotDateTime"
                      name="slotDateTime"
                      ...
                      onChange={handleChange}
                      min={minDateTime} // Set minimum date and time
                      required
                    />
                  </div>
                  <div className="form-group">
